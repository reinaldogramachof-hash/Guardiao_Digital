...
const { generateQuiz, startSimulation, replySimulation } = require('./src/ai-learning');
...
functions.http('api', (req, res) => {
  runWithCors(req, res, async (req, res) => {
    ...
    switch (path) {
      ...
      case '/learning/simulation/start':
        return startSimulation(req, res);

      case '/learning/simulation/reply':
        return replySimulation(req, res);
